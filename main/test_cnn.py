...
if torch.backends.mps.is_available():
    ...
    MODEL_PATH = r"trained_models_cnn/snake21_len80_max160_44000000_steps.zip"
...
if RENDER:
    env = SnakeEnv(seed=seed, length = 4, is_grow=True, limit_step=True, silent_mode=False)
else:
    env = SnakeEnv(seed=seed, length = 4, is_grow=True, limit_step=True, silent_mode=True)
