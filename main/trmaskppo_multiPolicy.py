...
class TRMaskablePPOMultiPolicy(OnPolicyAlgorithm):
    """
    ...
    def __init__(
        ...
        policy_model_paths: List[str],
        mc_value_model_paths: List[str],
        value_of_mc_policy_path: str,
        ...
        self.policy_model_paths = policy_model_paths
        self.mc_value_model_paths = mc_value_model_paths
        self.value_of_mc_policy_path = value_of_mc_policy_path
    ...
    def train(self) -> None:
        ...
        global mc_policy
        if mc_policy == None:
            mc_policy = MultiPolicy(self.env, self.policy_model_paths, self.mc_value_model_paths)

        global value_model
        if value_model == None:
            value_model = MaskablePPO.load(self.value_of_mc_policy_path, self.env)
            value_model.policy.set_training_mode(False)
