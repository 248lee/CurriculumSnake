...
def make_env(seed=0):
    def _init():
        env = SnakeEnv(seed=seed, length=80, is_grow=True, silent_mode=True)
...
def main():
    ...
    model = DVN(
        'trained_models_cnn/' + "snake_s6_l3_len72_clip_84000000_steps",
        "CnnPolicy",
        env,
        lr_schedule,
        buffer_size=140_000,
    ...
    ExperimentName = "DVN_transfer_s6to7_g985"
