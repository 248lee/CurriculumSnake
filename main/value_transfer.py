...
def make_env(seed=0):
    def _init():
        env = SnakeEnv(seed=seed, length="random", is_grow=True, silent_mode=True)
...
def main():
    ...
    model = DVN(
        'trained_models_cnn/' + "snake_s7_l4_grow_g985_160000000_steps",
        "CnnPolicy",
        env,
        lr_schedule,
        buffer_size=140_000,
    ...
    ExperimentName = "DVN_transfer_s7toBOSS_unfreeze_target_small_init"
