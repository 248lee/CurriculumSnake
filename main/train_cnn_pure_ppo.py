...
# Please type the file name of the resulting model here
ExperimentName = "snake_pure_len3_max130"
...
# This function controls the training environment
def make_env(seed=0):
    def _init():
        # Please config the environment parameters here
        env = SnakeEnv(seed=seed, length=3, max_length=130, is_grow=True, silent_mode=True)
